...
public class MainActivity extends Activity implements NavigationDrawerFragment.NavigationDrawerCallbacks {
	...
	public static final String SERVER_URL = "http://192.168.1.23/appsandroid/contacts.json";
	String leJson;
	...
	public void onNavigationDrawerItemSelected(int position) {
		...
		case 2:
			MessagesFragment messagesFragment = MessagesFragment.newInstance(position + 1);
			messagesFragment.setArguments(json);
			fragmentManager.beginTransaction().replace(R.id.container, messagesFragment)
			.commit();
			break;
